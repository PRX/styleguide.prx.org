    ...
    <section *ngIf="version.hasFileTemplates">
      <div class="uploads">
        <ng-container *ngFor="let ft of version.filesAndTemplates">
          <prx-templated-upload
            *ngIf="ft.tpl"
            [template]="ft.tpl"
            [file]="ft.file"
            [version]="version"
            prxClick
            [accept]="version.getContentType()"
          ></prx-templated-upload>
          <prx-illegal-upload *ngIf="!ft.tpl" [file]="ft.file" [version]="version"></prx-illegal-upload>
        </ng-container>
      </div>
    </section>
    ...
    <section prxClick>
      <section *ngIf="!version.hasFileTemplates">
        <div class="uploads" [prxFreeReorder]="version">
          ...
          <prx-free-upload *ngFor="let f of version.files" [file]="f" [version]="version" prxClick> </prx-free-upload>
        </div>
      </section>
