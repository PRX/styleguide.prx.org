...
@Component({
  selector: 'app-demo',
  template: `
    <h1 class="demo">Button</h1>
    <p class="desc">A style sheet for buttons (and some things that act and look like buttons.) PRX buttons have a flat 
      appearance with no border radius, drop shadow, or gradient.</p>
    <h2 class="demo">A note on .button:</h2>
    <ul class="doc">
    ...
    <h2 class="demo">Button, .button, and some support for input type=button|submit|reset</h2>
    <ul class="doc">
    ...
    <h2 class="demo">Button Link, i.e. <code>&lt;a class="button"&gt;</code></h2>
    <p class="desc">Sometimes you need a link that looks like a button, such as for opening external URLs</p>
    <ul class="doc">
      <li><code>background-color: @blue</code> with <code>background-color: @blue-emphasis</code> on <code>:hover</code></li>
      <li><code>color: @white</code></li>
    ...
    <h2 class="demo">Link Button, i.e. <code>&lt;button class="btn-link"&gt;</code></h2>
    <p class="desc">Sometimes you need a button with click behavior that looks like a link, such as for paging results</p>
    <ul class="doc">
    ...
    <h2 class="demo">Icon Button, i.e. <code>&lt;button class="btn-icon"&gt;</code></h2>
    <p class="desc">
    ...
    <h2 class="demo">Delete Button, i.e. <code>&lt;button class="delete"&gt;</code></h2>
    <ul class="doc">
      <li><code>color: @white</code></li>
    ...
    <h2 class="demo">Up Down Toggle Button</h2>
    <p class="desc">
